...
const navigationSections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        isActive: (pathname: string) => pathname === "/workspace-chat",
      },
      {
        ...
        isActive: (pathname: string) => pathname === "/workspace-warroom-enterprise",
        badge: "enterprise",
      },
      {
        id: "console",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        isActive: (pathname: string) => pathname.includes("/saintvision-institute") || pathname.includes("/research"),
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: "saintvision-group",
        title: "SaintVision Group",
        href: "/saintvisiongroup",
        icon: Building,
        description: "Parent company",
        isActive: (pathname: string) => pathname === "/saintvisiongroup",
      },
    ],
  },
  {
