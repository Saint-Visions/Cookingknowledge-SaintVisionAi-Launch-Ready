      ...
      <nav className="relative z-50 flex items-center justify-between p-6 lg:px-12">
        <div className="flex items-center space-x-2">
          <img
            ...
            className="w-12 h-12 object-contain filter brightness-125 contrast-110"
            style={{
              filter:
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <Badge
                            variant="secondary"
                            className="bg-charcoal-800 text-gold-300 border border-gold-500/30"
                          >
                            {category.count}
                          </Badge>
                        </div>
                  ...
                  <form className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <Input
                        ...
                        className="bg-charcoal-800 border-charcoal-600 text-white placeholder:text-white/70 focus:border-gold-500"
                      />
                      <Input
                    ...
                    <Textarea
                      ...
                      rows={4}
                      className="bg-charcoal-800 border-charcoal-600 text-white placeholder:text-white/70 focus:border-gold-500 resize-none"
                    />
                    <Button
                      type="submit"
